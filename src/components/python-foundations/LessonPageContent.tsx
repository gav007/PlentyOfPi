...
export default function LessonPageContent({ lesson, moduleTitle, prevLink, nextLink }: LessonPageContentProps) {
  return (
        ...
        <div className="mt-8 pt-6 border-t flex justify-between items-center">
          ...
          {nextLink ? (
            <Button asChild variant="default" size="sm">
             ...
             <Button asChild variant="default" size="sm">
                <Link href={`/lessons/python-foundations/`}> {/* Adjust if module specific dashboard is needed */}
