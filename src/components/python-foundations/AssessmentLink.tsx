...
export default function AssessmentLink() {
  return (
    <div className="text-center space-y-3">
      ...
      {/* Enable the button but the page itself will show 'Coming Soon' for the assessment content */}
      <Button asChild size="lg">
        <Link href="/lessons/python-foundations/assessment">
          <ClipboardCheck className="mr-2 h-5 w-5" /> Start Final Assessment
        </Link>
      </Button>
      <p className="text-xs text-muted-foreground">(Note: The assessment page content is currently under development.)</p>
    </div>
  );
}
