...
export default function OptionsJs({ options, selectedOption, correctOption, onSelect, disabled }: OptionsJsProps) {
  return (
        ...
        return (
          <Button
            ...
            className={cn(
              ...
              isSelected && !correctOption && "ring-2 ring-primary bg-primary/10",
              ...
              correctOption && isCorrect && !isSelected && "border-green-500 text-green-700"
            )}
