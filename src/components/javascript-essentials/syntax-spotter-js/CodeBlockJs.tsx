...
export default function CodeBlockJs({
  lines,
  errorLineIndex,
  selectedLineIndex,
  onLineSelect,
      ...
      {lines.map((line, index) => (
        <div
          ...
          className={cn(
            ...
            selectedLineIndex === index && errorLineIndex === undefined && "bg-blue-500/30 ring-1 ring-blue-400",
            errorLineIndex !== undefined && errorLineIndex === index && "bg-red-500/40 ring-1 ring-red-400",
            errorLineIndex !== undefined && selectedLineIndex === index && selectedLineIndex !== errorLineIndex && "bg-yellow-500/30 ring-1 ring-yellow-400"
          )}
          role="button"
        ...
        >
          ...
          <pre className="whitespace-pre-wrap text-sm leading-relaxed flex-1 group-hover:text-white transition-colors">{line || ' '}</pre>
        </div>
      ))}
    </div>
  );
